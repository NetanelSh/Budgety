...
var UIController = (function() {
  var DOMstrings = {
    ...
    percenteageLabel: '.budget__percentage--value',
    container: '.container'
  }
  return {
    getinput: function() {
    ...
    displayBudget: function(obj) {
      ...
      if(obj.percentage > 0) {
        document.querySelector(DOMstrings.percenteageLabel).textContent = obj.percentage + '%';
      } else {
        document.querySelector(DOMstrings.percenteageLabel).textContent = '--';
      }
    }
